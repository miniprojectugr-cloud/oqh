...
import LogoImage from '../assets/images/oqh_logo_1783951061100.jpg';
    ...
    >
      ...
      <FadeIn delay={0} y={-20} duration={0.8} as="nav">
        <div className="w-full flex items-center justify-between px-6 md:px-10 pt-6 md:pt-8 relative z-[10001]">
          <button
            ...
            className="flex items-center gap-2 md:gap-3 text-[#D7E2EA] font-black uppercase tracking-wider text-sm md:text-lg lg:text-[1.4rem] cursor-pointer hover:opacity-70 transition-opacity duration-200 text-left"
          >
            <img
              src={LogoImage}
          ...
          >
            <motion.span
              ...
              className="w-7 h-[2.5px] bg-[#D7E2EA] rounded-full block origin-center"
            />
            <motion.span
              animate={mobileMenuOpen ? { opacity: 0 } : { opacity: 1 }}
              transition={{ duration: 0.2 }}
              className="w-7 h-[2.5px] bg-[#D7E2EA] rounded-full block"
            />
            <motion.span
              animate={mobileMenuOpen ? { rotate: -45, y: -8 } : { rotate: 0, y: 0 }}
              transition={{ duration: 0.3 }}
      ...
      <div className="absolute left-1/2 -translate-x-1/2 z-10 w-[240px] sm:w-[300px] md:w-[350px] lg:w-[390px] xl:w-[420px] top-1/2 -translate-y-1/2 sm:top-auto sm:translate-y-0 sm:bottom-0 pointer-events-auto">
        <FadeIn delay={0.6} y={30} duration={1.0}>
          ...
          >
            <div className="w-full aspect-[3/4] overflow-hidden rounded-t-[5rem] sm:rounded-t-[7rem] md:rounded-t-[8rem] rounded-b-[1.5rem] border border-orange-500/60 shadow-[0_0_35px_rgba(249,115,22,0.4),0_30px_60px_rgba(0,0,0,0.85)] bg-transparent">
              <img
                src={RoboImage}
                alt="Orange Quantum Hub AI Robo Companion"
                referrerPolicy="no-referrer"
                className="w-full h-full object-cover select-none pointer-events-none mix-blend-screen filter contrast-[1.2] brightness-[1.05]"
              />
            </div>
          </Magnet>
        </FadeIn>
        ...
        <div className="fixed inset-0 bg-[#0C0C0C]/90 backdrop-blur-md flex items-center justify-center z-50 p-4 transition-all duration-300">
          ...
          >
            <button
              ...
              className="absolute top-4 right-4 text-gray-400 hover:text-white uppercase font-bold text-sm tracking-widest cursor-pointer"
            >
              [ Close ]
            </button>
            <h3 className="text-2xl font-black uppercase text-[#D7E2EA] mb-6 tracking-tight">
              Premium Solutions Suite
            </h3>
            <div className="space-y-6 text-[#D7E2EA]/80 font-light">
            ...
            <p className="mt-6 text-xs text-gray-500 uppercase tracking-wider text-center">
            ...
            >
              <div className="flex flex-col gap-6 text-left">
                <div className="flex flex-col gap-1 border-b border-white/5 pb-4 mb-4">
                  <span className="text-[10px] uppercase tracking-widest text-[#D7E2EA]/40 font-bold">
                    Navigation Menu
                  </span>
                ...
                <button
                  ...
                  className="text-left text-[#D7E2EA] hover:text-orange-500 font-bold uppercase tracking-widest text-lg py-3 transition-colors duration-200 border-b border-white/5 cursor-pointer active:text-orange-500"
                >
                  About
                </button>
                <button
              ...
              <div className="flex flex-col gap-2 border-t border-white/5 pt-6 text-left">
                ...
                <a
                  ...
                  className="text-xs font-mono text-[#D7E2EA]/70 hover:text-orange-500 transition-colors"
                >
