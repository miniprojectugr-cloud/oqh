    ...
    <AnimatePresence mode="wait">
      {!submitSuccess ? (
        ...
        >
          ...
          <p className="text-sm sm:text-base text-[#D7E2EA]/80 max-w-md leading-relaxed font-light">
        ...
        <div className="lg:col-span-5 flex flex-col justify-between text-left">
          <div className="flex flex-col">
            ...
            <FadeIn delay={0.3} y={35}>
              <p className="text-sm sm:text-base text-[#D7E2EA]/75 font-light leading-relaxed mb-8 max-w-md">
          ...
          <FadeIn delay={0.4} y={35} className="w-full">
            <div className="bg-[#141414]/90 border border-orange-500/50 shadow-[0_0_25px_rgba(249,115,22,0.25),0_10px_30px_rgba(0,0,0,0.5)] rounded-[2rem] p-6 sm:p-8 backdrop-blur-md relative overflow-hidden group">
              ...
              <div className="flex flex-col gap-5">
                <div>
                  <span className="text-[10px] uppercase tracking-widest text-[#D7E2EA]/40 font-bold block mb-1">
                    Managing Director
                  </span>
