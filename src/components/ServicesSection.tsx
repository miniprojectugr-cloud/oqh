      ...
      <div className="w-full max-w-none px-6 sm:px-12 md:px-20 lg:px-28 flex flex-col relative z-10">
        ...
        <div className="w-full text-center mb-16 sm:mb-20 md:mb-28">
          <FadeIn delay={0.1} y={30}>
            <span className="text-xs uppercase tracking-[0.25em] text-[#D7E2EA]/40 font-bold block mb-4">
              Core Capabilities
            </span>
          </FadeIn>
          ...
          <FadeIn delay={0.3} y={30}>
            <p className="text-sm sm:text-base text-[#D7E2EA]/60 max-w-xl mx-auto mt-6 font-light leading-relaxed">
          ...
          {SERVICES.map((service, i) => {
            return (
              <FadeIn
                ...
                className="w-full"
              >
                {/* 3D Flip Horizontal Container */}
                <div 
                  onClick={() => setFlippedService(flippedService === service.number ? null : service.number)}
                  className="w-full h-[290px] sm:h-[220px] md:h-[140px] perspective-1000 group cursor-pointer"
                >
                  <div className={`relative w-full h-full duration-700 preserve-3d transition-transform group-hover:[transform:rotateY(180deg)] ${flippedService === service.number ? '[transform:rotateY(180deg)]' : ''}`}>
                    ...
                    <div className="absolute inset-0 w-full h-full rounded-2xl border border-orange-500/60 overflow-hidden rotate-y-180 backface-hidden shadow-[0_0_20px_rgba(249,115,22,0.35),0_20px_40px_rgba(0,0,0,0.4)]">
                      ...
                      <div className="absolute inset-0 p-5 sm:p-7 flex flex-col md:flex-row md:items-center justify-between text-white relative z-10">
                        ...
                        <div className="text-left flex flex-col mb-2 md:mb-0">
                          <span className="font-mono text-[9px] text-[#D7E2EA]/50 tracking-widest uppercase mb-1">
