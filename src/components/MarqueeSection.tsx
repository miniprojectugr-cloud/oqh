  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-none px-6 sm:px-12 md:px-20 lg:px-28 mb-12 text-center">
        <span className="text-xs uppercase tracking-[0.2em] text-white/40 font-light block mb-2">
          VISUAL WORKFLOWS
        </span>
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-tight text-[#D7E2EA]">
      ...
      <div className="flex flex-col gap-6 md:gap-8">
        ...
        <div className="w-full overflow-hidden">
          <div
            ...
            className="flex flex-row gap-5 md:gap-6 whitespace-nowrap transition-transform duration-100 ease-out"
          >
            {row1Services.map((service, idx) => (
              <div
                key={`row1-${idx}`}
                className="flex-shrink-0 w-[300px] h-[200px] sm:w-[380px] sm:h-[240px] md:w-[440px] md:h-[280px] bg-[#141414] rounded-[24px] overflow-hidden border border-white/5 shadow-[0_20px_40px_rgba(0,0,0,0.6)] relative group cursor-pointer"
              >
                {/* Background Image */}
                <img
                ...
                {/* Cyber Gradient Glow */}
                <div className={`absolute inset-0 bg-gradient-to-t ${service.glow} mix-blend-screen opacity-60`} />
                ...
                <div className="absolute bottom-0 left-0 w-full p-5 sm:p-6 flex flex-col justify-end text-left">
                  <div className="backdrop-blur-md bg-black/40 border border-white/10 rounded-2xl p-3 sm:p-4 shadow-2xl">
                    <span className="text-[10px] uppercase tracking-widest text-[#D7E2EA]/50 font-bold block mb-1">
                      {service.tag}
                    </span>
